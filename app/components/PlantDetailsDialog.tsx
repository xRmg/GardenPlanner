...
import { PlantInstance } from './GardenGrid';
...
const PLANT_INFO: Record<string, {
  sunlight: string;
  water: string;
  spacing: string;
...
export function PlantDetailsDialog({ 
  ...
  const [pestEvents, setPestEvents] = useState<PestEvent[]>(plantInstance?.pestEvents || []);
          ...
          <div className="border rounded-lg p-4">
            ...
            <div className="mb-4 p-3 bg-gray-50 rounded">
              <div className="flex gap-2 mb-2">
                <select
                  value={newEventType}
                  onChange={(e) => setNewEventType(e.target.value as 'pest' | 'treatment')}
